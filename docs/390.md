...
> 原文：[http://book.iwonder.run/0day/Weblogic/（CVE-2019-2725）（CNVD-C-2019-48814）.html](http://book.iwonder.run/0day/Weblogic/（CVE-2019-2725）（CNVD-C-2019-48814）.html)
...
访问[http://www.0-sec.org/_async/AsyncResponseService](http://www.0-sec.org/_async/AsyncResponseService)

![image](img/9e0ceb9de311f67c2873a679253f5c88.png)

若出现以上情况，则有可能会存在漏洞。

### Win/Linux 通用写入 shell 代码（一）
...
> (注：上述报文中 servers/AdminServer/tmp/_WL_internal/bea_wls9_async_response/8tpkys/war/，servers/AdminServer/tmp/_WL_internal/bea_wls_internal/9j4dqk/war/ 均为默认路径，如果路径修改，可以配合反弹 shell 进行获取)
...
*   写入 webshell（需要公网） //这里提供两个代码

> 需要自己在公网上放置一个 webshell.txt
> 
> webshell 地址：[http://www.0-sec.org/_async/webshell.jsp](http://www.0-sec.org/_async/webshell.jsp)
...
> 写入的 webshell 地址为：[http://www/0-sec.org/_async/webshell.jsp?pwd=123&cmd=whoami](http://www/0-sec.org/_async/webshell.jsp?pwd=123&cmd=whoami)
...
> 写入的 webshell 地址为：[http://www.0-sec.org/bea_wls_internal/webshell.jsp?pwd=123&cmd=whoami](http://www.0-sec.org/bea_wls_internal/webshell.jsp?pwd=123&cmd=whoami)

### Win

*   反弹 shell

> 可直接使用 CobaltStrike 生成一个 payload.ps1 powershell 脚本，将该脚本放到公网上，然后使用如下报文即可
...
> 需要自己在公网上放置一个 webshell.txt
> 
> webshell 地址为：[http://www.0-sec.org/_async/webshell.jsp](http://www.0-sec.org/_async/webshell.jsp)
...
> 这两组代码的 webshell 地址为：[http://www.0-sec.org/_async/webshell.jsp?pwd=123&cmd=whoami](http://www.0-sec.org/_async/webshell.jsp?pwd=123&cmd=whoami)
...
> 这两组代码的 webshell 地址为：[http://www.0-sec.org/bea_wls_internal/webshell.jsp?pwd=123&cmd=whoami](http://www.0-sec.org/bea_wls_internal/webshell.jsp?pwd=123&cmd=whoami)
...
> [https://mp.weixin.qq.com/s?__biz=MzA3NjU5MTIxMg==&mid=2650560530&idx=1&sn=86f5e0811c003c71965a4fc088f18100&chksm=87560111b02188071b9a60a36316b931770b0ed58b02b63d2d2428a5120d6809030d94031589&scene=21#wechat_redirect](https://mp.weixin.qq.com/s?__biz=MzA3NjU5MTIxMg==&mid=2650560530&idx=1&sn=86f5e0811c003c71965a4fc088f18100&chksm=87560111b02188071b9a60a36316b931770b0ed58b02b63d2d2428a5120d6809030d94031589&scene=21#wechat_redirect)
