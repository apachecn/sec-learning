...
> 原文：[http://book.iwonder.run/0day/PHPOK/2.html](http://book.iwonder.run/0day/PHPOK/2.html)
...
private function _arclist($rs,$cache_id='')
{
    ...
    // 270 行 调用 arc_all 函数，将$orderby 传入
...
private function load_module($rs,$parent_rs='')
{
    ...
    // 208 行，通过 phpok 函数动态调用 _arclist()函数
...
> [https://xz.aliyun.com/t/6831](https://xz.aliyun.com/t/6831)
