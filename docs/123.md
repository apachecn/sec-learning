...
> 原文：[http://book.iwonder.run/0day/Eyoucms/3.html](http://book.iwonder.run/0day/Eyoucms/3.html)
...
public function changeTableVal()
{
    if (IS_AJAX_POST) {
        ...
        $id_name = input('post.id_name/s'); // 表主键 id 名
        $id_value = input('post.id_value/s'); // 表主键 id 值
...
![image](img/ec271bb7c20c2bf9dc2a8472136ce231.png)

## 四、参考链接

> [http://www.f4ckweb.top/index.php/archives/47/](http://www.f4ckweb.top/index.php/archives/47/)
