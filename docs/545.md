...
> 原文：[http://book.iwonder.run/iot/TP-Link/CVE-2017-16957.html](http://book.iwonder.run/iot/TP-Link/CVE-2017-16957.html)

## 一、漏洞简介

TP-Link TL-WVR 等都是中国普联（TP-LINK）公司的无线路由器产品。

多款 TP-Link 产品中存在命令注入漏洞。远程攻击者可通过向 cgi-bin/luci 发送 face 字段中带有 shell 元字符的 admin/diagnostic 命令利用该漏洞执行任意命令。
...
> [https://www.03sec.com/3207.shtml](https://www.03sec.com/3207.shtml)
