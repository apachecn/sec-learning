...
> 原文：[http://book.iwonder.run/0day/泛微 oa/1.html](http://book.iwonder.run/0day/泛微 oa/1.html)
...
[https://github.com/ianxtianxt/ecologyExp.jar](https://github.com/ianxtianxt/ecologyExp.jar)

使用方式：

jdk 1.8 以上，没混淆可以直接看源码

使用方法：

java -jar ecologyExp.jar [http://0-sec.org](http://0-sec.org)

源代码如下，编译好的在上方 github 链接里。
